...
//
#define NGD_HTTP_TIMEOUT_READ 60000 // 60s
#define NGD_HTTP_TIMEOUT_WRITE 60000 // 60s
#define NGD_HTTP_TIMEOUT_KEEP_ALIVE 30000 // 30s
//
#define NGD_HTTP_FULL_HEADER_DONE 1
//
#define NGD_HTTP_FULL_SEND_DONE 1
//
